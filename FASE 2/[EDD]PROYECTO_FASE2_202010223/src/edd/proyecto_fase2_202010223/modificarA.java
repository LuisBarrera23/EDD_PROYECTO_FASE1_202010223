...
public class modificarA extends javax.swing.JFrame {
    ...
    Cliente cliente;
    public modificarA(Cliente cli) {
        initComponents();
        this.cliente=cli;
        this.setTitle(cliente.getNombre());
        Entrada_nombre.setText(cliente.getNombre());
        Entrada_dpi.setText(String.valueOf(cliente.getDpi()));
        Entrada_contra.setText(cliente.getPassword());
    }
